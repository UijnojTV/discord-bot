...
module.exports = {
    run: message => {
        ...
        if (!role) return message.channel.send('Vous devez mentionner le rôle dont vous voulez voir les infos.')
        message.channel.send(new Discord.MessageEmbed()
            .addField('Rôle', role, true)
            .addField('Membre le possédant', role.members.size, true)
    ...
    guildOnly: true,
    help: {
        description: 'Donne les infos d\'un rôle.',
        syntax: '<@role>'
    }
}