...
module.exports = {
    run: async (message, args) => {
        ...
        if (!question) return message.channel.send('Veuillez indiquer une question à poser.')
        if (!choices.length) return message.channel.send('Veuillez indiquer au moin 1 choix.')
    ...
    help: {
        ...
        syntax: '<question> | [choix 1] | [choix 2]...'
    }
}