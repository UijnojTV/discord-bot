...
module.exports = {
    run: async (message, args) => {
        ...
        if (member.id === message.guild.ownerID) return message.channel.send('Vous ne pouvez pas unmute le propriétaire du serveur.')
        ...
        if (!muteRole) return message.channel.end('Il n\'y a pas de muterole.')
