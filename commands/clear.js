module.exports = {
    run: async (message, args) => {
        if (!message.member.hasPermission('MANAGE_MESSAGES')) return message.channel.send('Vous n\'avez pas la permission d\'utliser cette commande.')
        const count = args[0]
    ...
    guildOnly: true,
    help: {
        description: 'Supprime le nombre de messages indiqué.',
